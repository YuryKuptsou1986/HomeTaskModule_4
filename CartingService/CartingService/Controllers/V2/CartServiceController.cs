...
namespace CartingService.Controllers.V2
{
    ...
    public class CartServiceController : ControllerBase
    {
        ...
        public ActionResult<IEnumerable<ItemViewModel>> GetCartInfo([FromRoute] string cartId)
        {
            return Ok(_cartService.GetCartById(cartId).Items);
        }
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public ActionResult AddItem([FromBody] CartInsertViewModel cart)
        {
